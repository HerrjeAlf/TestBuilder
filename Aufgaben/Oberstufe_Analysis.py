...
def testaufgabe(nr, teilaufg=['a', 'b', 'c'], i=0, BE=[], gleichungen=[]):
    ...
    grafiken_aufgaben = []
    grafiken_loesung = []
    obj1_1, obj2_1, var_obj1_1, var_obj2_1 = [[2,2,2], [1,0,0]], [[2,3,3],[1,1,1]], ['a'], ['b']
    obj1_2, obj2_2, var_obj2_2 = [[2,2,2]], [[2,3,3],[1,0,0], [1,1,1]], ['a', 'b']
    obj1_3, obj2_3, var_obj2_3 = [[2,2,2]], [[1,0,0], [2,1,1]], ['a','b']
