...
for i in range(anzahl):
    ...
    Aufgaben = [[brueche_mul_div(1,['a'], wdh=3),
                 brueche_mul_div(2, ['b'], wdh=3),
                 brueche_mul_div(3, ['c'], wdh=3),
                 brueche_mul_div(4, ['d'], wdh=3),
                 brueche_mul_div(5, ['e'], wdh=3),
                 brueche_mul_div(6, ['f'], wdh=3)]]
